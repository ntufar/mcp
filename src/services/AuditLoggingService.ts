...
import { AccessLog, AccessLogData } from '../models/AccessLog';
...
export class AuditLoggingService {
  ...
  private async handleSecurityEvent(log: AccessLog): Promise<void> {
  ...
  private async persistToFile(log: AccessLog): Promise<void> {
    try {
