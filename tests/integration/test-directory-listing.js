...
(0, globals_1.describe)('Directory Listing Integration Tests', () => {
    let testDir;
    ...
    (0, globals_1.describe)('Basic Directory Listing', () => {
        (0, globals_1.it)('should list directory contents with files and subdirectories', async () => {
            ...
            (0, globals_1.expect)(directoryPath).toBe('IMPLEMENTATION_REQUIRED');
        });
        ...
        (0, globals_1.it)('should respect maxDepth parameter', async () => {
    ...
    (0, globals_1.describe)('File Information', () => {
        (0, globals_1.it)('should provide detailed file information', async () => {
        ...
        (0, globals_1.it)('should calculate total directory size', async () => {
    ...
    (0, globals_1.describe)('Sorting and Filtering', () => {
        (0, globals_1.it)('should sort files by name', async () => {
        ...
        (0, globals_1.it)('should sort files by size', async () => {
        ...
        (0, globals_1.it)('should sort files by modification time', async () => {
    ...
    (0, globals_1.describe)('Error Handling', () => {
        (0, globals_1.it)('should handle non-existent directories', async () => {
    ...
    (0, globals_1.describe)('Performance', () => {
        (0, globals_1.it)('should handle large directories efficiently', async () => {
        ...
        (0, globals_1.it)('should cache directory listings appropriately', async () => {
    ...
    (0, globals_1.describe)('Symbolic Links', () => {
        ...
        (0, globals_1.it)('should follow symbolic links to target directories', async () => {
...
//# sourceMappingURL=test-directory-listing.js.map