...
(0, globals_1.describe)('File Reading Integration Tests', () => {
    let testDir;
    ...
    (0, globals_1.describe)('Basic File Reading', () => {
        (0, globals_1.it)('should read text files with UTF-8 encoding', async () => {
        ...
        (0, globals_1.it)('should read JSON files and validate content', async () => {
        ...
        (0, globals_1.it)('should read markdown files', async () => {
    ...
    (0, globals_1.describe)('Encoding Detection', () => {
        (0, globals_1.it)('should auto-detect file encoding', async () => {
        ...
        (0, globals_1.it)('should handle UTF-16 encoded files', async () => {
        ...
        (0, globals_1.it)('should handle binary files appropriately', async () => {
    ...
    (0, globals_1.describe)('Size Limits and Streaming', () => {
        (0, globals_1.it)('should respect maximum file size limits', async () => {
        ...
        (0, globals_1.it)('should implement streaming for large files', async () => {
        ...
        (0, globals_1.it)('should handle partial file reading with offset', async () => {
    ...
    (0, globals_1.describe)('Content Type Detection', () => {
        (0, globals_1.it)('should detect content types correctly', async () => {
    ...
    (0, globals_1.describe)('Error Handling', () => {
        (0, globals_1.it)('should handle non-existent files', async () => {
        ...
        (0, globals_1.it)('should handle invalid encoding requests', async () => {
    ...
    (0, globals_1.describe)('Performance', () => {
        (0, globals_1.it)('should read small files quickly', async () => {
        ...
        (0, globals_1.it)('should handle concurrent file reads', async () => {
    ...
    (0, globals_1.describe)('Content Hashing', () => {
    ...
    (0, globals_1.describe)('Symbolic Links', () => {
        ...
        (0, globals_1.it)('should follow symbolic links when requested', async () => {
...
//# sourceMappingURL=test-file-reading.js.map