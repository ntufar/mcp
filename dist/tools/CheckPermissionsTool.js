...
exports.CheckPermissionsTool = void 0;
const PermissionService_1 = require("../services/PermissionService");
class CheckPermissionsTool {
    permissionService;
    constructor(config, pathValidationService, auditLoggingService) {
        this.permissionService = new PermissionService_1.PermissionService(config, pathValidationService);
    }
    /**
     ...
     */
    async checkBatchPermissions(requests, context) {
        const startTime = Date.now();
        const results = [];
        try {
     ...
     */
    async getDetailedPermissions(path, userId, context) {
        const startTime = Date.now();
        try {
            ...
            const operations = ['read', 'write', 'execute', 'list'];
...
exports.CheckPermissionsTool = CheckPermissionsTool;
//# sourceMappingURL=CheckPermissionsTool.js.map