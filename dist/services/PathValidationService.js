...
exports.PathValidationService = void 0;
class PathValidationService {
     ...
     */
    isWithinDepthLimit(path, maxDepth) {
    ...
    validateSecurityConstraints(path, options) {
        const violations = [];
    ...
    validateConfigurationConstraints(path) {
     ...
     */
    validatePathForOperation(path, operation, options = {}) {
...
exports.PathValidationService = PathValidationService;
//# sourceMappingURL=PathValidationService.js.map